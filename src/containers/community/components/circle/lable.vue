    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="title" label="标签标题"></el-table-column>
          <el-table-column align="center" prop="weight" label="排序"></el-table-column>
          <!-- <el-table-column align="center" align="center" prop="is_show" label="显示">
    ...
    <el-dialog :title="modelTitle" :visible.sync="ifChanCate" width="900px">
      <div class="box">
        <div class="box-i">
          ...
          <input width type="text" v-model="basicInformation.name" placeholder="请输入标签名称" />
        </div>
        <div class="box-i">
          <div class="box-left">标签标题：</div>
          <input width type="text" v-model="basicInformation.title" placeholder="请输入标签标题" />
        </div>
        <div class="box-i">
        ...
        <!-- <div class="box-i">
          ...
          <div class="box-right">
            <el-radio v-model="basicInformation.stytus" :label="1">是</el-radio>
            <el-radio v-model="basicInformation.stytus" :label="2">否</el-radio>
          </div>
        </div>-->
      </div>
