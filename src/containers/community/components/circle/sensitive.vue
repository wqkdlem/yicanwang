    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="title" label="敏感词"></el-table-column>
          <el-table-column align="center" prop="filter" label="过滤符"></el-table-column>
          ...
          <el-table-column align="center" label="操作" width="120">
            ...
            <template slot-scope="scope">
              ...
              <el-button
                ...
                style="color:#FB6534
                "
                @click="ifShowDele=true;changeCateId=scope.row.title"
              >删除</el-button>
            </template>
          </el-table-column>
        </el-table>
    ...
    <el-dialog :title="modelTitle" class="abow_dialog" :visible.sync="ifChanCate" width="900px">
      <div class="box">
        <div class="box-i">
          ...
          <input type="text" placeholder="请输入敏感词" v-model="basicInformation.title_new" />
        </div>
        <div class="box-i">
          <div class="box-left">过滤符：</div>
          <input type="text" placeholder="请输入过滤符" v-model="basicInformation.repeat" />
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    onChangeCate(data) {
      ...
      this.modelTitle = "修改过滤词";
      this.basicInformation.title_old = data.title;
      this.basicInformation.repeat = data.filter;
    },
    onAddCate() {
      this.ifChanCate = true;
      this.modelTitle = "新增过滤词";
