<template>
  <div class="purchaseHelp">
    <div class="purchaseHelp-top">
      <div class="purchaseHelp-top-tit">
        帮助列表
        <span style="color:#3CB371">(2)</span>
      </div>
      <div class="purchaseHelp-top-con">
        <div class="purchaseHelp-top-con-left">
          <div class="purchaseHelp-top-con-i">
            关键字：
    ...
    <div class="purchaseHelp-bot">
      <div class="purchaseHelp-bot-top">
        <div class="purchaseHelp-bot-top-i">
...
.purchaseHelp {
  ...
  .purchaseHelp-top {
    ...
    .purchaseHelp-top-tit {
      font-size: 18px;
      font-weight: 500;
      color: rgba(51, 51, 51, 1);
    }
    .purchaseHelp-top-con {
      margin-top: 10px;
      display: flex;
      flex-direction: row;
      justify-content: space-between;
      .purchaseHelp-top-con-left {
        display: flex;
        flex-direction: row;
        justify-content: start;
        .purchaseHelp-top-con-i {
          margin-right: 60px;
          display: flex;
          align-items: center;
        }
  ...
  .purchaseHelp-bot {
    ...
    display: flex;
    flex-direction: column;
    .purchaseHelp-bot-top {
      display: flex;
      justify-content: start;
      .purchaseHelp-bot-top-i {
        // width: 130px;
        margin-right: 30px;
        padding: 0 12px;
        box-sizing: border-box;
