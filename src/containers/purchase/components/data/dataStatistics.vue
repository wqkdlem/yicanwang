<template>
  <div class="dataStatistics">
    <div class="dataStatistics-top">
      <div class="dataStatistics-top-tit">
        数据统计
        <span style="color:#999999">+运费减-所有优惠,实付金额的计算</span>
      </div>
      <div class="dataStatistics-top-con">
        <div class="dataStatistics-top-con-left">
          <div class="dataStatistics-top-con-i">
            时间搜索：
              <el-date-picker
              v-model="date"
              type="daterange"
    ...
    <div class="dataStatistics-bot">
      <div class="dataStatistics-bot-top">
        <div class="dataStatistics-bot-top-i">
          <i class="el-icon-plus"></i>
          <span>新增帮助</span>
        </div>
      </div>
      <div class="dataStatistics-bot-bot">
...
.dataStatistics {
  ...
  .dataStatistics-top {
    ...
    .dataStatistics-top-tit {
      font-size: 18px;
      font-weight: 500;
      color: rgba(51, 51, 51, 1);
    }
    .dataStatistics-top-con {
      margin-top: 10px;
      display: flex;
      flex-direction: row;
      justify-content: space-between;
      .dataStatistics-top-con-left {
        display: flex;
        flex-direction: row;
        justify-content: start;
        flex-wrap: wrap;
        align-items: flex-end;
        .dataStatistics-top-con-i {
          margin-right: 60px;
          display: flex;
          align-items: center;
          margin-top: 8px;
