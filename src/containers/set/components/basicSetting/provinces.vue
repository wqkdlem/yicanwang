    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="template_name" label="邮编"></el-table-column>
          <el-table-column align="center" prop="count" label="名称"></el-table-column>
          <el-table-column align="center" prop="template_name" label="全拼"></el-table-column>
          <el-table-column align="center" prop="template_name" label="首字母"></el-table-column>
          <!-- <el-table-column align="center" align="center" prop="status" label="启用">
          ...
          <el-table-column align="center" label="操作" width="160">
            ...
            <template slot-scope="scope">
              ...
              <el-button type="text" size="small" style="color:#3CB371">城市数量（0）</el-button>
            </template>
          </el-table-column>
        </el-table>
        <div class="block">
