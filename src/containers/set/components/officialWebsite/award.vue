  ...
  <div class="categoryList">
    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="title" label="简介" width="240"></el-table-column>
          <el-table-column align="center" prop="title" label="图片" width="240">
            <img
              slot-scope="solt"
              src
              alt
              style="width:60px;height:60px;display:blocck;border-radius:50%;"
            />
          </el-table-column>
    ...
    <el-dialog :title="modelTitle" :visible.sync="ifChanCate" width="600px">
      <div class="box">
        ...
        <div class="box-i">
          <div class="box-left">简介：</div>
          <input type="text" placeholder="请输入排序" />
        </div>
        <div class="box-i">
          <div class="box-left">状态显示：</div>
          <div class="box-right">
...
export default {
  ...
  methods: {
    ...
    onChangeCate(data) {
      ...
      this.modelTitle = "修改奖项";
      this.basicInformation = data;
    },
    onAddCate() {
      this.ifChanCate = true;
      this.modelTitle = "新增奖项";
    ...
    async onSureChangeLable() {
      ...
      let url = "/admin/community_label";
      if (!name) return this.$message("请先输入奖项名称");
      let data = {};
      if (this.modelTitle == "修改奖项") {
        let data = {
          name,
          title,
          weight,
