<template>
  <div class="categoryList">
    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="title" label="平台图标" width="240">
            <img slot-scope="solt" src alt style="width:140px;height:80px;display:blocck;" />
          </el-table-column>
          <el-table-column align="center" prop="title" label="平台URL"></el-table-column>
          <!-- <el-table-column align="center" prop="title" label="媒体"></el-table-column> -->

          <el-table-column align="center" prop="create_time" label="类别"></el-table-column>
          <el-table-column align="center" prop="weight" label="备注"></el-table-column>
    ...
    <el-dialog :title="modelTitle" :visible.sync="ifChanCate" width="600px">
      <div class="box">
        <div class="box-i">
          <div class="box-left">管理平台名称：</div>
          <input type="text" placeholder="请输入管理平台名称" />
        </div>
        <div class="box-i box-img">
          <div class="box-left">平台图标：</div>
          <img
            class="box-right"
            style="width:180px;height:180px"
            :src="basicInformation.bImg||uplodingImg"
            alt
          />
        </div>
        <div class="box-i">
          <div class="box-left">URL地址：</div>
          <input type="text" placeholder="请输入URL地址" />
        </div>
        <div class="box-i">
          <div class="box-left">备注：</div>
          <textarea name id cols="200" rows="10" placeholder="请输入备注"></textarea>
        </div>
        <div class="box-i">
          <div class="box-left">平台类别：</div>
          <el-select v-model="dateData" placeholder="请选择">
            <el-option
              v-for="item in searchData.level"
              :key="item.name"
    ...
    <el-dialog title="删除等级" :visible.sync="ifShowDele" width="400px">
      <div class="box">
        <div class="box-con">确认删除管理平台？</div>
        <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    onChangeCate(data) {
      ...
      this.modelTitle = "修改管理平台";
      this.basicInformation = data;
    },
    onAddCate() {
      this.ifChanCate = true;
      this.modelTitle = "新增管理平台";
    ...
    async onSureChangeLable() {
      ...
      let url = "/admin/community_label";
      if (!name) return this.$message("请先输入管理平台名称");
      let data = {};
      if (this.modelTitle == "修改管理平台") {
        let data = {
          name,
          title,
          weight,
