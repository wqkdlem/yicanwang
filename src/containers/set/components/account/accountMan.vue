<template>
  <div class="categoryList">
    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="title" label="账号"></el-table-column>
          <el-table-column align="center" prop="title" label="密码"></el-table-column>
          <el-table-column align="center" prop="create_time" label="备注"></el-table-column>
    ...
    <el-dialog :title="modelTitle" :visible.sync="ifChanCate" width="600px">
      <div class="box">
        <div class="box-i">
          <div class="box-left">平台名称</div>
          <input type="text" placeholder="请输入平台名称" />
        </div>
        <div class="box-i">
          <div class="box-left">平台账号：</div>
          <input type="text" placeholder="请输入平台账号" />
        </div>
        <div class="box-i">
          <div class="box-left">平台密码：</div>
          <input type="text" placeholder="请输入平台密码" />
        </div>
        <div class="box-i">
          <div class="box-left">备注内容：</div>
          <textarea name id cols="200" rows="10" placeholder="请输入备注内容"></textarea>
        </div>
        <div class="box-i">
...
export default {
  ...
  methods: {
    ...
    async onSureChangeLable() {
      ...
      let url = "/admin/community_label";
      if (!name) return this.$message("请先输入管理员名称");
      let data = {};
