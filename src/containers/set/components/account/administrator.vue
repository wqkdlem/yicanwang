<template>
  <div class="categoryList">
    ...
    <div class="categoryList-bot">
      ...
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="title" label="组权限"></el-table-column>
          <el-table-column align="center" prop="title" label="最后登录时间"></el-table-column>
          <el-table-column align="center" prop="create_time" label="最后登录IP"></el-table-column>
    ...
    <el-dialog :title="modelTitle"  class="abow_dialog" :visible.sync="ifChanCate" width="600px">
      <div class="box">
        <div class="box-i">
          <div class="box-left">管理员名称：</div>
          <input type="text" placeholder="请输入管理员名称" />
        </div>
        <div class="box-i">
          <div class="box-left">组权限：</div>
          <el-select v-model="dateData" placeholder="请选择">
            <el-option
              v-for="item in searchData.level"
              :key="item.name"
