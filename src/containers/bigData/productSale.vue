    ...
    <div class="categoryList-bot">
      <div class="categoryList-bot-bot">
        <el-table
          ...
          show-summary
        >
          <el-table-column align="center" prop="id" label="图片" width="200">
            <img slot-scope="scope" :src="scope.row.goodImg" style="width:180px;height:70px;" alt />
          </el-table-column>
          <el-table-column align="center" prop="goods_name" label="产品"></el-table-column>
          <el-table-column align="center" prop="sum_goods_num" width="180" label="真实销量(件)"></el-table-column>
          <el-table-column align="center" prop="sum_total" label="订单总销(元)"></el-table-column>
          <el-table-column align="center" prop="sum_profit" label="应得利润(元)" width="200"></el-table-column>
        </el-table>
        <div class="block">
