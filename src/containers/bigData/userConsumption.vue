    ...
    <div class="categoryList-bot">
      <div class="categoryList-bot-bot">
        <el-table :data="tableData.data" border :height="700" style="width: 100%;">
          ...
          <el-table-column align="center" prop="id" label="用户">
            <div slot-scope="scope">
              <img :src="scope.row.headImg" style="width:80px;height80px;" alt />
              <div>{{scope.row.nickname}}</div>
            </div>
          </el-table-column>
          <el-table-column align="center" prop="userlevel_amount" label="消费总额(元)"></el-table-column>
          <el-table-column align="center" prop="sum_order_num" width="180" label="消费次数"></el-table-column>
          <el-table-column align="center" prop="title" label="查看">
            <div>查看订单</div>
          </el-table-column>
        </el-table>
        <div class="block">
