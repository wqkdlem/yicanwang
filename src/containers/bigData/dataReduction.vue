  ...
  <div class="categoryList">
    ...
    <div class="categoryList-bot">
      <div class="categoryList-bot-bot">
        ...
        >
          <el-table-column align="center" prop="order_date" width="110" label="日期"></el-table-column>
          <el-table-column align="center" prop="order_num" label="订单数量"></el-table-column>
          <el-table-column align="center" prop="order_money" label="订单金额"></el-table-column>
          <el-table-column align="center" prop="order_soup_num" label="汤料数量"></el-table-column>
          <el-table-column align="center" prop="order_soup_money" label="汤料金额" width="200"></el-table-column>
          <el-table-column align="center" prop="order_soup_costprice" label="汤料成本"></el-table-column>
          <el-table-column align="center" prop="order_soup_costmoney" label="汤料加工费"></el-table-column>
          <el-table-column align="center" prop="chongzhi_num" label="充值数量"></el-table-column>
          <el-table-column align="center" prop="chongzhi_money" label="充值数量"></el-table-column>
        </el-table>
        <div class="block">
